        ...
        <nav className='header__navbar'>
          <ul className='header__navbar-list'>
            <li className='header__navbar-item'>
              <img className='logo' src='https://media.twofour54.com/sites/5/2019/10/netflix-768x583.jpg' alt='' />
            </li>
                  ...
                  <li className='header__notify-item header__notify-item--viewed'>
                    <a href='' className='header__notify-link'>
                      ...
                      <div className='header__notify-info'>
                        <span className='header__notify-name'>Stranger Things</span>
                        <span className='header__notify-description'>Season 5 now available</span>
                      </div>
                    </a>
                  </li>
                  <li className='header__notify-item header__notify-item--viewed'>
